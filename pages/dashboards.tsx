...
import CustomfullCalender from '@/common_component/fullCalender';
...
export default function Test() {
    ...
    const owner = [
        { title: `Meetings`, monthCount: 3, todayCount: 150, icon: '⏰', name1: 'Today', name2: 'Tommorrow', bgColor: 'bg-indigo-100' },
        { title: `Tomorrow Meetings`, monthCount: 4, todayCount: 300, icon: '⏰', name1: 'Today', name2: 'Month', bgColor: 'bg-green-100' },
        { title: 'Income', monthCount: 400, todayCount: 150, icon: "₹", name1: 'Today', name2: 'Total', bgColor: 'bg-fuchsia-100' },
        { title: 'Leads', monthCount: 200, todayCount: 2000, icon: '📋', name1: 'Today', name2: 'Month', bgColor: 'bg-teal-100' },
        { title: 'Opportunities', monthCount: 25, todayCount: 5, icon: '🌟', name1: 'Today', name2: 'Active', bgColor: 'bg-pink-100' },
    ];
    ...
    const BDE = [
        ...
        { title: 'Calls', monthCount: 150, todayCount: 300, icon: '📞', name1: 'Today', name2: 'Month' },
        { title: 'Appoinments', monthCount: 150, todayCount: 2, icon: '👨‍💼', name1: 'Today', name2: 'Month' },
        { title: 'Meetings', monthCount: 150, todayCount: 300, icon: '💰', name1: 'Today', name2: 'Month' },
        { title: 'Proposals', monthCount: 150, todayCount: 3, icon: '⏳', name1: 'Month', name2: 'Target' },
        { title: 'Closures', monthCount: 150, todayCount: 300, icon: '💵', name1: 'Month', name2: 'Target' },
    ];
        ...
        <div className="p-2">
            ...
            <div className="flex flex-col gap-4 lg:flex-row ">
                ...
                <div className="panel w-full">
                    <CustomfullCalender events={events} eventClick={(event)=>console.log("first",event)} />
            ...
            <SimpleGrid cols={2} spacing="lg" className="mt-2">
                <Card shadow="sm" radius="lg">
                    ...
                    {isMounted && <ReactApexChart options={customerFeedbackChart.options} series={customerFeedbackChart.series} type="bar" height={320} width={'100%'} />}
                ...
                <Card shadow="sm" radius="lg">
                    ...
                    {isMounted && <ReactApexChart options={LeadStatus.options} series={LeadStatus.series} type="bar" height={320} width={'100%'} />}
                ...
                <Card shadow="sm" radius="lg">
                    ...
                    {isMounted && <ReactApexChart options={leadSourceChart.options} series={leadSourceChart.series} type="donut" height={320} width={'100%'} />}
                </Card>
                ...
                <Card shadow="sm" radius="lg">
                    ...
                    {isMounted && <ReactApexChart options={pipelineValueByStageChart.options} series={pipelineValueByStageChart.series} type="pie" height={320} width={'100%'} />}
                </Card>
            </SimpleGrid>
        </div>
    );
