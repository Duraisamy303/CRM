            ...
            <div>
                <DataTable
                    ...
                    columns={[
                        ...
                        ...(state.role !== 'TM' ? [{ accessor: 'opportunity', title: 'Opportunity', sortable: true }] : []),
                        ...
                        ...(state.role === 'DM' || state.role === 'ADMIN' || state.role === 'BDE' ? [{ accessor: 'statusDate', title: 'Status Date', sortable: true }] : []),

                        ...(state.role === 'TM' || state.role === 'BDM' || state.role === 'BDE' ? [{ accessor: 'followUp', title: 'Follow up  ', sortable: true }] : []),
