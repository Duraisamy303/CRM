...
const Index = () => {
    ...
    const telecallerPipelineData = [
        { name: 'Leads Generated', value: 500 },
        { name: 'Calls Attempted', value: 400 },
        { name: 'Connected Calls', value: 300 },
        { name: 'Interested Leads', value: 200 },
        { name: 'Follow-Ups Scheduled', value: 150 },
        { name: 'Meetings/Presentations', value: 100 },
        { name: 'Proposals Sent', value: 50 },
        { name: 'Closures', value: 20 },
    ];
    ...
    const chartOptions = {
        ...
        xaxis: {
            categories: TeleData.map((data) => data.title),
        },
        yaxis: {
            title: {
                text: 'Count',
    ...
    const chartSeries = [
        {
            name: 'Month Count',
            data: TeleData.map((data) => data.monthCount),
        },
        {
            name: 'Today Count',
            data: TeleData.map((data) => data.todayCount),
        },
    ];
    return (
        <>
            <div className="p-2">
                ...
                <div className=" gap-4">
                    ...
                    {state.loading ? (
                        ...
                        <>
                            <>
                                <div className="grid  gap-5 pb-5 pt-5">
                                    {/* Lead Source Chart */}
                            ...
                            <div className=" col-span-12 flex flex-col   md:col-span-12 ">
                                ...
                                <div className="mt-2 flex h-[480px] flex-wrap gap-5">
                                    <div className="panel flex w-full flex-col items-center justify-center  p-3 ">
                                        ...
                                        <Funnel data={telecallerPipelineData} />
