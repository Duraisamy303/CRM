                                ...
                                <ul>
                                    <li className="nav-item">
                                        <Link href="/" className="group">
                                            <div className="flex items-center">
                                                <IconLeads className="shrink-0 group-hover:!text-primary" />
                                    ...
                                    <li className="nav-item">
                                        <Link href="/opportunities" className="group">
                                            <div className="flex items-center">
                                                <IconOpportunity className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Opportunities')}</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
