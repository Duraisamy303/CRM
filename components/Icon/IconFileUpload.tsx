...
const IconFileUpload: FC<IconCodeProps> = ({ className }) => {
    // Handler for drag start
    const handleDragStart = (event: React.DragEvent<HTMLDivElement>) => {
        event.dataTransfer.setData('text/plain', 'icon-code'); // Sets data type and payload
    ...
    return (
        <div
            ...
            onDragStart={handleDragStart} // Binds drag start handler
        >
